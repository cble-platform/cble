module github.com/cble-platform/backend
...
require (
	...
	github.com/pulumi/pulumi v3.91.0+incompatible // indirect
	github.com/pulumi/pulumi-openstack v3.13.3+incompatible // indirect
