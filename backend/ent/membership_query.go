...
func (mq *MembershipQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Membership, error) {
	...
	if query := mq.withProject; query != nil {
		if err := mq.loadProject(ctx, query, nodes, nil,
			func(n *Membership, e *Project) { n.Edges.Project = e }); err != nil {
			return nil, err
		}
	}
...
func (mq *MembershipQuery) loadProject(ctx context.Context, query *ProjectQuery, nodes []*Membership, init func(*Membership), assign func(*Membership, *Project)) error {
