...
export default function DestroyDeployment() {
  ...
  const [destroyDeployment, { data: destroyDeploymentData, error: destroyDeploymentError, loading: destroyDeploymentLoading }] =
  ...
  useEffect(() => {
    if (destroyDeploymentData?.destroyDeployment) {
      enqueueSnackbar({ message: `Destroyed deployment "${getDeploymentData?.deployment.name}"!`, variant: "success" });
  ...
  return (
    <Container sx={{ py: 3 }}>
      ...
      <Typography variant="body1">
        This will destroy this deployment and all resources created as a part of the deployment.{" "}
        <ErrorSpan>All data will be lost!</ErrorSpan>
      </Typography>
      ...
      <ContainerFab
        ...
        disabled={getDeploymentData === undefined || destroyDeploymentLoading || destroyDeploymentData != null}
      >
